...
//        });
        ...
        txtViewTop.setTextColor(Color.RED);
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    PrintWriter output = new PrintWriter( new BufferedWriter( new OutputStreamWriter(sk.getOutputStream())),true);
                    output.println("test");
                    Log.d("==================","ket noi den server ok"+sk.getRemoteSocketAddress());
